...
export default function ConfirmAccount() {
  ...
  return (
    <div className={styles['confirmAccount-container']}
    style={
        ...
        <h1 className={styles['confirmAccount-message']}>
            {isLoading ? 'Yükleniyor...' : isSuccess ? (
                <>
                    Giriş yapmak için lütfen&nbsp;
                    <Link to='/login' onClick={handleClick} className={styles['confirmAccountToLogin']}>tıklayınız.
                    </Link>
                </>
            )
            : 
                <>
                    ...
                    <Link to='/login' onClick={handleClick} className={styles['confirmAccountToLogin']}>tıklayınız.</Link>
                </>
            }
